...
describe('SimpleWallet-test', function () {
    let accounts
    let provider
    let simpleWallet
    let zkID
    ...
    it('mint ZKID', async function () {
        await zkID.mint(accounts[0].address, 2022)
    ...
    it('deploy SimpleWallet', async function () {
        ...
        simpleWallet = await SimpleWallet.deploy(2022, zkPass.address, zkID.address)
        await simpleWallet.deployed()
        console.log('simpleWallet deployed:', simpleWallet.address)
        console.log('simpleWallet owner:', await simpleWallet.owner())
    })


    it('deposit', async function () {
        await usdt.transfer(simpleWallet.address, m(100, 18))
        console.log('deposit ERC20 done')
